...
import { ENABLE_DEBUG, FRAME_TIME, SCREEN_WIDTH } from "../../constants/game.js"
...
import { FighterHurtBy } from "../../constants/fighter.js"
...
export class Fighter {
    ...
    states = {
        [FighterState.IDLE]: {
            ...
            validFrom: [
                FighterState.IDLE, FighterState.WALK_FORWARD, FighterState.WALK_BACKWARD, FighterState.JUMP_BACKWARD,
                FighterState.JUMP_UP, FighterState.JUMP_FORWARD, FighterState.JUMP_BACKWARD, FighterState.JUMP_LAND,
                FighterState.CROUCH_UP, FighterState.IDLE_TURN, FighterState.LIGHT_PUNCH, FighterState.MEDIUM_PUNCH, 
                FighterState.HEAVY_PUNCH, FighterState.LIGHT_KICK, FighterState.MEDIUM_KICK, FighterState.HEAVY_KICK,
 ...
 handleCrouchDownState(time) {
    ...
    if(!control.isDown(this.playerId)) {
        ...
        this.setAnimationFrame(
         Math.max(this.animations[FighterState.CROUCH_UP][this.animationFrame].length - this.animationFrame),
         time,
        )
    }
 }
 ...
 updateStageConstraints(time, context, camera) {
    ...
    updateAttackBoxCollided(time) {
        ...
        for (const [hurtLocation, hurtBox] of Object.entries(this.opponent.boxes.hurt)) {
            ...
            this.opponent.handleAttackHit(time, attackStrength, attackType, hitPosition, hurtLocation, FighterHurtBy.FIGHTER)
            return
