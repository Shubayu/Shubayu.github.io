...
const frames = new Map([
    ["hadouken-fireball-1", [[[400, 2756, 43, 32], [25, 16]], [-15, -13, 30, 24], [-28, -20, 38]]],
    ["hadouken-fireball-2", [[[460, 2761, 56, 28], [25, 16]], [-15, -13, 30, 24], [-28, -20, 38]]],
    ["hadouken-fireball-3", [[[0, 0, 0, 0], [0, 0]], [-15, -13, 30, 24], [-28, -20, 38]]],

    ["hadouken-collide-1", [[[543, 2767, 26, 20], [13, 10]], [0, 0, 0, 0]]],
    ["hadouken-collide-2", [[[590, 2766, 15, 25], [9, 13]], [0, 0, 0, 0]]],
    ["hadouken-collide-3", [[[626, 2764, 28, 28], [16, 14]], [0, 0, 0, 0]]],
])
...
const animations = {
    ...
    [FireballState.COLLIDED]: [
        ["hadouken-collide-1", 2], ["hadouken-collide-2", 2], ["hadouken-collide-3", 9]
    ]
}
...
export class Fireball {
    ...
    updateMovement(time, camera) {
        ...
        this.fighter.opponent.handleAttackHit(time, FighterAttackStrength.HEAVY, FighterAttackType.PUNCH, undefined, FighterHurtBox.HEAD, FighterHurtBy.FIREBALL)
    }
    ...
    draw(context, camera) {
        ...
        DEBUG.drawBox(context, camera, this.position, this.direction, collisionDimensions, "#FF0000")
        DEBUG.drawCross(context, camera, this.position, "#FF")
    }
}