...
export class StatusBar {
    ...
    frames = new Map([
        ...
        [`${TIME_FRAME_KEYS[1]}-0`, [16, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-1`, [32, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-2`, [48, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-3`, [64, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-4`, [80, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-5`, [96, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-6`, [112, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-7`, [128, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-8`, [144, 190, 14, 16]],
        [`${TIME_FRAME_KEYS[1]}-9`, [160, 190, 14, 16]],
